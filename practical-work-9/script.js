...
// 1.2.14 
console.log(arr1.filter((element) => element > 4));
...
// 1.2.29
for (let object of map1.values()) {
  console.log(`${object.Name} is ${object.level} in ${object.skill}`);
}
//1.2.30
let set1 = new Set();
set1.add(Petryk);
